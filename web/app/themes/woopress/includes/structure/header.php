...
remove_action( 'wp_head', 'parent_post_rel_link', 10 );				// Parent rel link
remove_action( 'wp_head', 'start_post_rel_link', 10 );				// Start post rel link
remove_action( 'wp_head', 'adjacent_posts_rel_link_wp_head', 10 );	// Adjacent post rel link
