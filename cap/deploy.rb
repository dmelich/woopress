...
set :npm_target_path, -> { "#{fetch(:release_path)}/web/app/themes/woopress" }
set :npm_flags, '--silent --no-progress'

set :bower_target_path, -> { "#{fetch(:release_path)}/web/app/themes/woopress" }

set :gulp_file, -> { release_path.join('web/app/themes/woopress/gulpfile.js') }
